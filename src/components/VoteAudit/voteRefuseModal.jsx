...
const VoteRefuseModal = (props) => {
    ...
    return (
        <div>
            ...
            >
                <TextArea rows={4} value={props.data.refuseVoteTextarea}  onChange={ (e) => handleInputChange(e,'refuseVoteTextarea') } placeholder='请填写拒绝原因' />
            </Modal>
        </div>
    );
};
...
export default connect(mapStateToProps, null)(VoteRefuseModal);